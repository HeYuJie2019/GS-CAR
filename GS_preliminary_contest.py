...
def red():
    ...
    S.write(bytes.fromhex('ff 02 07 2b 03'))
def green():
    S.write(bytes.fromhex('ff 01 07 28 00'))
    S.write(bytes.fromhex('ff 02 07 12 09'))
def blue():
    S.write(bytes.fromhex('ff 01 07 28 00'))
    S.write(bytes.fromhex('ff 02 07 13 06'))
# 折叠
def arm_fold():
