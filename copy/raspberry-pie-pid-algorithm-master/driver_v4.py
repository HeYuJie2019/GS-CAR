...
class PID_MOTOR_4D(object):
    ...
    def PID_MotorCtl_L1(self, target, current):
        ...
        # PID计算电机输出PWM值
        self.L1_motor_pwm_out += self.ax_motor_kp*bias*self.PID_SCALE + self.ax_motor_kd*(bias-self.L1_bias_last)*self.PID_SCALE + self.ax_motor_ki*self.L1_bias_integral*self.PID_SCALE
    ...
    def PID_MotorCtl_L2(self, target, current):
        ...
        # PID计算电机输出PWM值
        self.L2_motor_pwm_out += self.ax_motor_kp*bias*self.PID_SCALE + self.ax_motor_kd*(bias-self.L2_bias_last)*self.PID_SCALE + self.ax_motor_ki*self.L2_bias_integral*self.PID_SCALE
    ...
    def PID_MotorCtl_R1(self, target, current):
        ...
        # PID计算电机输出PWM值
        self.R1_motor_pwm_out += self.ax_motor_kp*bias*self.PID_SCALE + self.ax_motor_kd*(bias-self.R1_bias_last)*self.PID_SCALE + self.ax_motor_ki*self.R1_bias_integral*self.PID_SCALE
    ...
    def PID_MotorCtl_R2(self, target, current):
        ...
        # PID计算电机输出PWM值
        self.R2_motor_pwm_out += self.ax_motor_kp*bias*self.PID_SCALE + self.ax_motor_kd*(bias-self.R2_bias_last)*self.PID_SCALE + self.ax_motor_ki*self.R2_bias_integral*self.PID_SCALE
